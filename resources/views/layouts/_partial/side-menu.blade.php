...
<div class="menu" id="side-menu">
	...
	@if(!Auth::check())
		  <ul>
			  <h2 class="ui header">เข้าสู่ระบบ</h2>
	...
	@else
			<ul >
				<h4 class="ui left aligned header">ยินดีต้อนรับเข้าสู่ระบบ</h4>
	          ...
	          <li class="dropdown">
	            <a href="#" data-toggle="dropdown"class="item "><i class="building icon"></i>จัดการห้องแล็บ <i class="icon-arrow"></i></a>
	              ...
	              <li><a href="{{ route('booking.list')}}"class="item "><i class="configure icon"></i>แก้ไขการจองห้องแล็บ</a></li>
	              </ul>
	          </li>
	          ...
	          <li class="dropdown">
	            ...
	            <ul class="dropdown-menu">
	              ...
	              <li><a href="{{ url('room/list')}}"class="item "><i class="configure icon"></i>แก้ไขห้องแล็บ</a></li>
	              </ul>
	          </li>
